...
#
#   - flatpak/io.github.unmq.kaforge.metainfo.xml — prepend the
...
VERSION=${TAG#v}
DATE=$(date +%Y-%m-%d)
METAINFO=flatpak/io.github.unmq.kaforge.metainfo.xml
