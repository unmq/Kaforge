...
impl ZipWriter {
    ...
    /// Adds one file. `name` uses `/` separators (`logs/kaforge.log.2026-08-22`).
...
mod tests {
    ...
    fn entries_round_trip_and_the_directory_is_consistent() {
        ...
        zip.add("logs/kaforge.log.2026-08-22", &big).expect("add");
        ...
        assert_eq!(entries[1].0, "logs/kaforge.log.2026-08-22");
